...
Libraries/iLLD/TC26B/Tricore/Cpu/Trap/%.src: ../Libraries/iLLD/TC26B/Tricore/Cpu/Trap/%.c Libraries/iLLD/TC26B/Tricore/Cpu/Trap/subdir.mk
	...
	cctc -D__CPU__=tc26xb "-fD:/Project/ADS_Project/BBBCAR-V3/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -o "$@"  "$<"  -cs --dep-file="$(@:.src=.d)" --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
